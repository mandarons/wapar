...
export class InstallationsService {
  constructor(
    @InjectModel(Installation) private installationModel: typeof Installation,
  ) {}
  async create(
    data: IInstallationRecordAttributes,
    ...
    try {
      ...
      returnValue = utils.constructDatabaseSuccessResponse(
        createdEntry.toJSON(),
      );
    } catch (error: any) {
