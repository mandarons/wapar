...
CREATE INDEX `idx_installation_country_code` ON `Installation` (`country_code`);--> statement-breakpoint
CREATE INDEX `idx_installation_updated_at` ON `Installation` (`updated_at`);